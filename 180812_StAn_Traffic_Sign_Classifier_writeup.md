...
[image5]: docu_images/01_01_Random_Images.png
[image6]: docu_images/01_01_Random_Images.png
...
In order to plot a set of traffic sign images with labels I created the function `plot_traffic_signs`. I used this function to understand the picture content by looking at the dataset in the following ways.
...
* A high contrast image for each label

![alt text][image3]

* The average image for each label
