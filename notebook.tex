...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}35}]:} \PY{k}{with} \PY{n}{tf}\PY{o}{.}\PY{n}{Session}\PY{p}{(}\PY{p}{)} \PY{k}{as} \PY{n}{sess}\PY{p}{:}
...
Model saved
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}36}]:} \PY{k}{with} \PY{n}{tf}\PY{o}{.}\PY{n}{Session}\PY{p}{(}\PY{p}{)} \PY{k}{as} \PY{n}{sess}\PY{p}{:}
...
Images}\label{load-and-output-the-images}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}37}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Load the images and plot them here.}
         \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Feel free to use as many code cells as needed.}
...
Image}\label{predict-the-sign-type-for-each-image}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}38}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Run the predictions here and use the model to output the prediction for each image.}
...
INFO:tensorflow:Restoring parameters from ../../GD\_GitHubData/temp\_data\textbackslash{}tsclass
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}39}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Calculate the accuracy for these 5 new images. }
...
notice \texttt{{[}3,\ 0,\ 5{]}} are the corresponding indices.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}40}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Print out the top five softmax probabilities for the predictions on the German traffic sign images found on the web. }
         \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Feel free to use as many code cells as needed.}
...
Your output should look something like this (above)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}41}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Visualize your network\PYZsq{}s feature maps here.}
         \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Feel free to use as many code cells as needed.}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}42}]:} \PY{c+c1}{\PYZsh{} define constants}
...
traffic signs ;-)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}43}]:} \PY{c+c1}{\PYZsh{} define constants}
...
larger picture.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}44}]:} \PY{c+c1}{\PYZsh{} define constants}
         ...
         \PY{c+c1}{\PYZsh{} bdisplaydeep    : boolean for \PYZsq{}display deep information\PYZsq{}}
             ...
             \PY{k}{for} \PY{n}{largeimage} \PY{o+ow}{in} \PY{p}{[}\PY{n}{largeimages}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{]}\PY{p}{:}
                 ...
                 \PY{k}{for} \PY{n}{scale} \PY{o+ow}{in} \PY{n}{scales}\PY{p}{:}
                     ...
                     \PY{n}{scale\PYZus{}factor} \PY{o}{=} \PY{p}{(}\PY{n}{scale} \PY{o}{/} \PY{n}{image\PYZus{}shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}
                 ...
                 \PY{k}{for} \PY{n}{idx}\PY{p}{,} \PY{n}{section} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{matching\PYZus{}image\PYZus{}section\PYZus{}locations\PYZus{}sorted\PYZus{}reverse}\PY{p}{)}\PY{p}{:}
                     ...
                     \PY{n}{cv2}\PY{o}{.}\PY{n}{polylines}\PY{p}{(}\PY{n}{largeimagesigns}\PY{p}{,} \PY{p}{[}\PY{n}{points}\PY{p}{]}\PY{p}{,} \PY{k+kc}{True}\PY{p}{,} \PY{p}{(}\PY{n}{colorvalue}\PY{p}{,} \PY{n}{colorvalue}\PY{p}{,} \PY{n}{colorvalue}\PY{p}{)}\PY{p}{,} \PY{n}{thickness} \PY{o}{=} \PY{n}{linewidth}\PY{p}{)}
