...
{\color{incolor}In [{\color{incolor}3}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Replace each question mark with the appropriate value. }
        ...
        \PY{n}{hist\PYZus{}train} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{histogram}\PY{p}{(}\PY{n}{y\PYZus{}train}\PY{p}{,} \PY{n}{n\PYZus{}classes}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
        \PY{n}{hist\PYZus{}valid} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{histogram}\PY{p}{(}\PY{n}{y\PYZus{}valid}\PY{p}{,} \PY{n}{n\PYZus{}classes}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
        \PY{n}{hist\PYZus{}test} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{histogram}\PY{p}{(}\PY{n}{y\PYZus{}test}\PY{p}{,} \PY{n}{n\PYZus{}classes}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
        \PY{n}{plot1} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{bar}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{n}{n\PYZus{}classes}\PY{p}{)}\PY{p}{,} \PY{n}{hist\PYZus{}test}\PY{p}{,} \PY{n}{color} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{red}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{plot2} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{bar}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{n}{n\PYZus{}classes}\PY{p}{)}\PY{p}{,} \PY{n}{hist\PYZus{}valid}\PY{p}{,} \PY{n}{bottom} \PY{o}{=} \PY{n}{hist\PYZus{}test}\PY{p}{,} \PY{n}{color} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{lightgreen}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{plot3} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{bar}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{n}{n\PYZus{}classes}\PY{p}{)}\PY{p}{,} \PY{n}{hist\PYZus{}train}\PY{p}{,} \PY{n}{bottom} \PY{o}{=} \PY{n}{hist\PYZus{}test}\PY{o}{+}\PY{n}{hist\PYZus{}valid}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{blue}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Traffic sign class}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Number of data sets}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{legend}\PY{p}{(}\PY{p}{(}\PY{n}{plot3}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{n}{plot2}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} \PY{n}{plot1}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Training}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Validation}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Testing}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}8}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Define your architecture here.}
        ...
        \PY{k}{def} \PY{n+nf}{LeNet\PYZus{}adjusted3}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{tf\PYZus{}keep\PYZus{}prob}\PY{p}{,} \PY{n}{bdisplay}\PY{p}{)}\PY{p}{:}
        \PY{c+c1}{\PYZsh{} ...}
        \PY{c+c1}{\PYZsh{} This function calculates the LeNet logits for input x}
        \PY{c+c1}{\PYZsh{} ...}
        \PY{c+c1}{\PYZsh{} Inputs}
        ...
        \PY{c+c1}{\PYZsh{} logits : probabilities of individual classes in input image}
            ...
            \PY{c+c1}{\PYZsh{} Layer 3: Convolutional. Output = 6x6x128.}
            \PY{n}{conv3\PYZus{}W} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{Variable}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{truncated\PYZus{}normal}\PY{p}{(}\PY{n}{shape} \PY{o}{=} \PY{p}{(}\PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{54}\PY{p}{,} \PY{l+m+mi}{128}\PY{p}{)}\PY{p}{,} \PY{n}{mean} \PY{o}{=} \PY{n}{mu}\PY{p}{,} \PY{n}{stddev} \PY{o}{=} \PY{n}{sigma}\PY{p}{)}\PY{p}{)}
            \PY{n}{conv3\PYZus{}b} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{Variable}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{l+m+mi}{128}\PY{p}{)}\PY{p}{)}
            ...
            \PY{c+c1}{\PYZsh{} display information}
            \PY{k}{if} \PY{n}{bdisplay}\PY{p}{:}
                \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Conv: shape}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{p}{[}\PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{54}\PY{p}{,} \PY{l+m+mi}{128}\PY{p}{]}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{zeros}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+m+mi}{128}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{mean}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{mu}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{stddev}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{sigma}\PY{p}{)}
                \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Conv: strides}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{padding}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{VALID}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Conv: inp}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{conv2}\PY{p}{)}
                \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Conv: W}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{conv3\PYZus{}W}\PY{p}{)}
                \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Conv: b}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{conv3\PYZus{}b}\PY{p}{)}
                \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Conv: out}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{conv3}\PY{p}{)}
            
            \PY{c+c1}{\PYZsh{} Activation and drop out}
            \PY{n}{conv3} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{relu}\PY{p}{(}\PY{n}{conv3}\PY{p}{)}
            \PY{n}{conv3} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{dropout}\PY{p}{(}\PY{n}{conv3}\PY{p}{,} \PY{n}{tf\PYZus{}keep\PYZus{}prob}\PY{p}{)}
        
            \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Convolutional layer   3 :}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{p}{[}\PY{l+m+mi}{10}\PY{p}{,} \PY{l+m+mi}{10}\PY{p}{]}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{input dimension with depth}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+m+mi}{54}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{and}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{p}{[}\PY{l+m+mi}{6}\PY{p}{,} \PY{l+m+mi}{6}\PY{p}{]}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{output dimensions with depth}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+m+mi}{128}\PY{p}{)}
            
            \PY{c+c1}{\PYZsh{} Flatten. Input = 6x6x128. Output = 4608.}
            \PY{n}{fc0}   \PY{o}{=} \PY{n}{flatten}\PY{p}{(}\PY{n}{conv3}\PY{p}{)}
            
            \PY{c+c1}{\PYZsh{} Layer 3: Fully Connected. Input = 4608. Output = 800.}
            \PY{n}{fc1\PYZus{}W} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{Variable}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{truncated\PYZus{}normal}\PY{p}{(}\PY{n}{shape}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{4608}\PY{p}{,} \PY{l+m+mi}{800}\PY{p}{)}\PY{p}{,} \PY{n}{mean} \PY{o}{=} \PY{n}{mu}\PY{p}{,} \PY{n}{stddev} \PY{o}{=} \PY{n}{sigma}\PY{p}{)}\PY{p}{)}
            \PY{n}{fc1\PYZus{}b} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{Variable}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{l+m+mi}{800}\PY{p}{)}\PY{p}{)}
            \PY{n}{fc1}   \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{matmul}\PY{p}{(}\PY{n}{fc0}\PY{p}{,} \PY{n}{fc1\PYZus{}W}\PY{p}{)} \PY{o}{+} \PY{n}{fc1\PYZus{}b}
            
            \PY{c+c1}{\PYZsh{} display information}
            \PY{k}{if} \PY{n}{bdisplay}\PY{p}{:}
                \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Full: shape}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{p}{[}\PY{l+m+mi}{4608}\PY{p}{,} \PY{l+m+mi}{800}\PY{p}{]}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{zeros}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+m+mi}{800}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{mean}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{mu}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{stddev}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{sigma}\PY{p}{)}
                \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Full: inp}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{fc0}\PY{p}{)}
                \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Full: W}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{fc1\PYZus{}W}\PY{p}{)}
                \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Full: b}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{fc1\PYZus{}b}\PY{p}{)}
                \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Full: fc}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{fc1}\PY{p}{)}
            ...
            \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Fully connected layer 1 :}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+m+mi}{4608}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{input dimensions and}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+m+mi}{800}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{output dimensions}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
            ...
            \PY{k}{return} \PY{n}{logits}\PY{p}{,} \PY{p}{(}\PY{n}{conv1\PYZus{}W}\PY{p}{,} \PY{n}{conv2\PYZus{}W}\PY{p}{,} \PY{n}{conv3\PYZus{}W}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{c+c1}{\PYZsh{} this cell is not used}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}10}]:} \PY{c+c1}{\PYZsh{} this cell is not used}
...
{\color{incolor}In [{\color{incolor}11}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Train your model here.}
         ...
         \PY{n}{keep\PYZus{}prob} \PY{o}{=} \PY{l+m+mf}{0.7}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} define pipelines}
         ...
         \PY{c+c1}{\PYZsh{}logits\PYZus{}orig, conv\PYZus{}Ws = LeNet(x, bdisplay)}
         \PY{c+c1}{\PYZsh{}logits\PYZus{}adjusted, conv\PYZus{}Ws = LeNet\PYZus{}adjusted(x, tf\PYZus{}keep\PYZus{}prob, bdisplay)}
         \PY{n}{logits\PYZus{}adjusted3}\PY{p}{,} \PY{n}{conv\PYZus{}Ws} \PY{o}{=} \PY{n}{LeNet\PYZus{}adjusted3}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{tf\PYZus{}keep\PYZus{}prob}\PY{p}{,} \PY{n}{bdisplay}\PY{p}{)}
         \PY{n}{logits} \PY{o}{=} \PY{n}{logits\PYZus{}adjusted3}
...
See @\{tf.nn.softmax\_cross\_entropy\_with\_logits\_v2\}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{k}{def} \PY{n+nf}{evaluate}\PY{p}{(}\PY{n}{session}\PY{p}{,} \PY{n}{X\PYZus{}data}\PY{p}{,} \PY{n}{y\PYZus{}data}\PY{p}{,} \PY{n}{batch\PYZus{}size}\PY{p}{)}\PY{p}{:}
         \PY{c+c1}{\PYZsh{} ...}
         \PY{c+c1}{\PYZsh{} This function plots a set of traffic sign images}
         \PY{c+c1}{\PYZsh{} ...}
         \PY{c+c1}{\PYZsh{} Inputs}
...
{\color{incolor}In [{\color{incolor}14}]:} \PY{k}{with} \PY{n}{tf}\PY{o}{.}\PY{n}{Session}\PY{p}{(}\PY{p}{)} \PY{k}{as} \PY{n}{sess}\PY{p}{:}
             ...
             \PY{c+c1}{\PYZsh{} initialize variables}
             \PY{n}{validation\PYZus{}accuracy\PYZus{}store} \PY{o}{=} \PY{p}{[}\PY{p}{]}
             ...
             \PY{k}{for} \PY{n}{idx} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{epochs}\PY{p}{)}\PY{p}{:}
                 ...
                 \PY{n}{validation\PYZus{}accuracy\PYZus{}store}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{validation\PYZus{}accuracy}\PY{p}{)}
             ...
             \PY{n}{plotfigure}\PY{p}{,} \PY{n}{plotaxes} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{subplots}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{,} \PY{n}{figsize} \PY{o}{=} \PY{p}{(}\PY{l+m+mi}{6}\PY{p}{,} \PY{l+m+mi}{3}\PY{p}{)}\PY{p}{)}
             \PY{n}{plotfigure}\PY{o}{.}\PY{n}{tight\PYZus{}layout}\PY{p}{(}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{validation\PYZus{}accuracy\PYZus{}store}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
Image}\label{predict-the-sign-type-for-each-image}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}17}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Run the predictions here and use the model to output the prediction for each image.}
...
INFO:tensorflow:Restoring parameters from ../../GD\_GitHubData/temp\_data\textbackslash{}tsclass
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}18}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Calculate the accuracy for these 5 new images. }
...
notice \texttt{{[}3,\ 0,\ 5{]}} are the corresponding indices.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}19}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Print out the top five softmax probabilities for the predictions on the German traffic sign images found on the web. }
         \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Feel free to use as many code cells as needed.}
...
Your output should look something like this (above)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}20}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Visualize your network\PYZsq{}s feature maps here.}
         \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Feel free to use as many code cells as needed.}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}21}]:} \PY{c+c1}{\PYZsh{} define constants}
         ...
         \PY{n}{probe\PYZus{}image\PYZus{}norm} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{asarray}\PY{p}{(}\PY{p}{(}\PY{p}{(}\PY{n}{probe\PYZus{}image} \PY{o}{/} \PY{l+m+mf}{127.5}\PY{p}{)} \PY{o}{\PYZhy{}} \PY{l+m+mi}{1}\PY{p}{)}\PY{p}{,} \PY{n}{np}\PY{o}{.}\PY{n}{float32}\PY{p}{)}
         \PY{c+c1}{\PYZsh{}probe\PYZus{}image\PYZus{}norm = 0 * np.ones\PYZus{}like(probe\PYZus{}image\PYZus{}norm)}
         ...
         \PY{n}{conv1\PYZus{}W}\PY{p}{,} \PY{n}{conv2\PYZus{}W}\PY{p}{,} \PY{n}{conv3\PYZus{}W} \PY{o}{=} \PY{n}{conv\PYZus{}Ws}
         ...
         \PY{k}{with} \PY{n}{tf}\PY{o}{.}\PY{n}{Session}\PY{p}{(}\PY{p}{)} \PY{k}{as} \PY{n}{sess}\PY{p}{:}
             ...
             \PY{c+c1}{\PYZsh{} display second layer}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Third convolutional layer}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
             \PY{n}{outputFeatureMap}\PY{p}{(}\PY{n}{sess}\PY{p}{,} \PY{n}{probe\PYZus{}image}\PY{p}{,} \PY{n}{conv3\PYZus{}W}\PY{p}{)}
\end{Verbatim}
...
traffic signs ;-)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}22}]:} \PY{c+c1}{\PYZsh{} define constants}
...
INFO:tensorflow:Restoring parameters from ../../GD\_GitHubData/temp\_data\textbackslash{}tsclass
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_46_11.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_46_12.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_46_13.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_46_14.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_46_15.png}
    \end{center}
    { \hspace*{\fill} \\}
...
{\color{incolor}In [{\color{incolor}23}]:} \PY{c+c1}{\PYZsh{} define constants}
         ...
         \PY{c+c1}{\PYZsh{} bdisplaydeep    : boolean for \PYZsq{}display deep information\PYZsq{}}
             ...
             \PY{n}{max\PYZus{}scale} \PY{o}{=} \PY{p}{(}\PY{l+m+mi}{320} \PY{o}{/} \PY{l+m+mi}{10} \PY{o}{*} \PY{l+m+mi}{8}\PY{p}{)}
             \PY{n}{stride} \PY{o}{=} \PY{l+m+mi}{5}
             \PY{n}{smalllinewidth} \PY{o}{=} \PY{p}{(}\PY{l+m+mi}{1} \PY{o}{/} \PY{l+m+mi}{4}\PY{p}{)}
             \PY{n}{linewidth} \PY{o}{=} \PY{p}{(}\PY{l+m+mi}{1} \PY{o}{/} \PY{l+m+mi}{2}\PY{p}{)}
             \PY{n}{horizontalplotsize} \PY{o}{=} \PY{l+m+mi}{3}
             \PY{n}{verticalplotsize} \PY{o}{=} \PY{p}{(}\PY{p}{(}\PY{l+m+mi}{2} \PY{o}{/} \PY{l+m+mi}{5}\PY{p}{)} \PY{o}{*} \PY{n}{k\PYZus{}size}\PY{p}{)}
             \PY{n}{dpi} \PY{o}{=} \PY{l+m+mi}{80}
             ...
             \PY{k}{for} \PY{n}{largeimage} \PY{o+ow}{in} \PY{n}{largeimages}\PY{p}{:}
                 ...
                 \PY{c+c1}{\PYZsh{} initialize array for all large images}
                 \PY{n}{image\PYZus{}sections} \PY{o}{=} \PY{p}{[}\PY{p}{]}
                 \PY{n}{image\PYZus{}section\PYZus{}locations} \PY{o}{=} \PY{p}{[}\PY{p}{]}
                 ...
                 \PY{k}{for} \PY{n}{scale} \PY{o+ow}{in} \PY{n}{scales}\PY{p}{:}
                     ...
                     \PY{n}{scale\PYZus{}factor} \PY{o}{=} \PY{p}{(}\PY{n}{scale} \PY{o}{/} \PY{n}{image\PYZus{}shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}
                     \PY{n}{new\PYZus{}height} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{int32}\PY{p}{(}\PY{n}{scale\PYZus{}factor} \PY{o}{*} \PY{n}{image\PYZus{}shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}
                     ...
                     \PY{k}{if} \PY{p}{(}\PY{p}{(}\PY{n}{xoffsets} \PY{o}{\PYZgt{}} \PY{l+m+mi}{0}\PY{p}{)} \PY{o}{\PYZam{}} \PY{p}{(}\PY{n}{yoffsets} \PY{o}{\PYZgt{}} \PY{l+m+mi}{0}\PY{p}{)}\PY{p}{)}\PY{p}{:}
                         ...
                         \PY{c+c1}{\PYZsh{} display information}
                         \PY{k}{if} \PY{n}{bdisplay}\PY{p}{:}
                             \PY{c+c1}{\PYZsh{}print(scale, image\PYZus{}shape, scale\PYZus{}factor, xoffsets, yoffsets)}
                         ...
                         \PY{k}{for} \PY{n}{yoffset} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{yoffsets}\PY{p}{)}\PY{p}{:}
                             \PY{k}{for} \PY{n}{xoffset} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{xoffsets}\PY{p}{)}\PY{p}{:}
                                 ...
                                 \PY{n}{image\PYZus{}section\PYZus{}locations}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{int32}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{float64}\PY{p}{(}\PY{p}{[}\PY{n}{xstart}\PY{p}{,} \PY{n}{xend}\PY{p}{,} \PY{n}{ystart}\PY{p}{,} \PY{n}{yend}\PY{p}{]}\PY{p}{)} \PY{o}{/} \PY{n}{scale\PYZus{}factor}\PY{p}{)}\PY{p}{)}
                                 
                                 \PY{c+c1}{\PYZsh{} display information}
                                 \PY{k}{if} \PY{p}{(}\PY{n}{bdisplay} \PY{o}{\PYZam{}} \PY{n}{bdisplaydeep}\PY{p}{)}\PY{p}{:}
                                     \PY{c+c1}{\PYZsh{}print(np.int32(np.float64([xstart, xend, ystart, yend]) / scale\PYZus{}factor))}
                 ...
                 \PY{n}{image\PYZus{}section\PYZus{}locations} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{asarray}\PY{p}{(}\PY{n}{image\PYZus{}section\PYZus{}locations}\PY{p}{)}
                 ...
                 \PY{c+c1}{\PYZsh{} define pipeline (must be called each time before running session below, i.e. cannot be outside of for loop)}
                 \PY{n}{top\PYZus{}k} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{top\PYZus{}k}\PY{p}{(}\PY{n}{logits}\PY{p}{,} \PY{n}{k} \PY{o}{=} \PY{n}{k\PYZus{}size}\PY{p}{)}
                 ...
                 \PY{n}{e\PYZus{}x} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{exp}\PY{p}{(}\PY{n}{top\PYZus{}k\PYZus{}pred}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]} \PY{o}{\PYZhy{}} \PY{n}{np}\PY{o}{.}\PY{n}{max}\PY{p}{(}\PY{n}{top\PYZus{}k\PYZus{}pred}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{)}
                 \PY{n}{all\PYZus{}top\PYZus{}k\PYZus{}percentages} \PY{o}{=} \PY{n}{e\PYZus{}x} \PY{o}{/} \PY{n}{e\PYZus{}x}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{p}{)}
                 ...
                 \PY{c+c1}{\PYZsh{} ensure to have matching locations}
                 \PY{n}{matching\PYZus{}image\PYZus{}section\PYZus{}locations} \PY{o}{=} \PY{p}{[}\PY{p}{]}
                 \PY{k}{for} \PY{n}{image\PYZus{}section\PYZus{}location} \PY{o+ow}{in} \PY{n}{image\PYZus{}section\PYZus{}locations}\PY{p}{:}
                     \PY{k}{for} \PY{n}{idx} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{k\PYZus{}size}\PY{p}{)}\PY{p}{:}
                         \PY{n}{matching\PYZus{}image\PYZus{}section\PYZus{}locations}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{image\PYZus{}section\PYZus{}location}\PY{p}{)}
                 \PY{n}{matching\PYZus{}image\PYZus{}section\PYZus{}locations} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{asarray}\PY{p}{(}\PY{n}{matching\PYZus{}image\PYZus{}section\PYZus{}locations}\PY{p}{)}
                 ...
                 \PY{n}{matching\PYZus{}image\PYZus{}section\PYZus{}locations\PYZus{}sorted} \PY{o}{=} \PY{n}{matching\PYZus{}image\PYZus{}section\PYZus{}locations}\PY{p}{[}\PY{n}{args\PYZus{}top\PYZus{}k\PYZus{}percentages}\PY{p}{]}
                 
                 \PY{c+c1}{\PYZsh{} display image with identified traffic sign locations}
                 \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Image with most probable sign locations:}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                 \PY{n}{largeimagesigns} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{copy}\PY{p}{(}\PY{n}{largeimage}\PY{p}{)}
                 \PY{n}{matching\PYZus{}image\PYZus{}section\PYZus{}locations\PYZus{}sorted\PYZus{}reverse} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{flip}\PY{p}{(}\PY{n}{matching\PYZus{}image\PYZus{}section\PYZus{}locations\PYZus{}sorted}\PY{p}{[}\PY{p}{:}\PY{p}{(}\PY{n}{k\PYZus{}size}\PY{o}{*}\PY{n}{k\PYZus{}size}\PY{p}{)}\PY{p}{]}\PY{p}{)}
                 \PY{n}{section\PYZus{}dims} \PY{o}{=} \PY{n}{matching\PYZus{}image\PYZus{}section\PYZus{}locations\PYZus{}sorted\PYZus{}reverse}\PY{o}{.}\PY{n}{shape}
                 \PY{k}{for} \PY{n}{idx}\PY{p}{,} \PY{n}{section} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{matching\PYZus{}image\PYZus{}section\PYZus{}locations\PYZus{}sorted\PYZus{}reverse}\PY{p}{)}\PY{p}{:}
                     \PY{n}{xstart}\PY{p}{,} \PY{n}{xend}\PY{p}{,} \PY{n}{ystart}\PY{p}{,} \PY{n}{yend} \PY{o}{=} \PY{n}{section}
                     \PY{n}{points} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{n}{ystart}\PY{p}{,} \PY{n}{xstart}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{n}{ystart}\PY{p}{,} \PY{n}{xend}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{n}{yend}\PY{p}{,} \PY{n}{xend}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{n}{yend}\PY{p}{,} \PY{n}{xstart}\PY{p}{]}\PY{p}{]}\PY{p}{)}
                     \PY{n}{colorvalue} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{l+m+mi}{255} \PY{o}{*} \PY{p}{(}\PY{n}{idx} \PY{o}{/} \PY{n}{section\PYZus{}dims}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{)}
                     \PY{n}{varylinewidth} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{int}\PY{p}{(}\PY{n}{smalllinewidth} \PY{o}{/} \PY{n}{scale\PYZus{}factor}\PY{p}{)}
                     \PY{n}{cv2}\PY{o}{.}\PY{n}{polylines}\PY{p}{(}\PY{n}{largeimagesigns}\PY{p}{,} \PY{p}{[}\PY{n}{points}\PY{p}{]}\PY{p}{,} \PY{k+kc}{True}\PY{p}{,} \PY{p}{(}\PY{n}{colorvalue}\PY{p}{,} \PY{n}{colorvalue}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{)}\PY{p}{,} \PY{n}{thickness} \PY{o}{=} \PY{n}{varylinewidth}\PY{p}{)}
                 \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{largeimagesigns}\PY{p}{)}
                 \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}        
                 ...
                 \PY{n}{top\PYZus{}sections} \PY{o}{=} \PY{p}{[}\PY{p}{]}
                 \PY{k}{for} \PY{n}{idx}\PY{p}{,} \PY{n}{top\PYZus{}k} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{top\PYZus{}ks\PYZus{}sorted}\PY{p}{)}\PY{p}{:}
                     \PY{k}{if} \PY{o+ow}{not} \PY{n}{top\PYZus{}k} \PY{o+ow}{in} \PY{n}{top\PYZus{}label\PYZus{}nums}\PY{p}{:}
                         ...
                         \PY{n}{top\PYZus{}sections}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{matching\PYZus{}image\PYZus{}section\PYZus{}locations\PYZus{}sorted}\PY{p}{[}\PY{n}{idx}\PY{p}{]}\PY{p}{)}
                 
                 \PY{c+c1}{\PYZsh{} display image with identified traffic sign locations}
                 \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Image with most probable sign locations (single sign labels):}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                 \PY{n}{largeimagesigns} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{copy}\PY{p}{(}\PY{n}{largeimage}\PY{p}{)}
                 \PY{n}{top\PYZus{}sections\PYZus{}reverse} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{flip}\PY{p}{(}\PY{n}{top\PYZus{}sections}\PY{p}{[}\PY{p}{:}\PY{n}{k\PYZus{}size}\PY{p}{]}\PY{p}{)}
                 \PY{n}{section\PYZus{}dims} \PY{o}{=} \PY{n}{top\PYZus{}sections\PYZus{}reverse}\PY{o}{.}\PY{n}{shape}
                 \PY{k}{for} \PY{n}{idx}\PY{p}{,} \PY{n}{section} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{top\PYZus{}sections\PYZus{}reverse}\PY{p}{)}\PY{p}{:}
                     \PY{n}{xstart}\PY{p}{,} \PY{n}{xend}\PY{p}{,} \PY{n}{ystart}\PY{p}{,} \PY{n}{yend} \PY{o}{=} \PY{n}{section}
                     \PY{n}{points} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{n}{ystart}\PY{p}{,} \PY{n}{xstart}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{n}{ystart}\PY{p}{,} \PY{n}{xend}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{n}{yend}\PY{p}{,} \PY{n}{xend}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{n}{yend}\PY{p}{,} \PY{n}{xstart}\PY{p}{]}\PY{p}{]}\PY{p}{)}
                     \PY{n}{colorvalue} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{l+m+mi}{255} \PY{o}{*} \PY{p}{(}\PY{n}{idx} \PY{o}{/} \PY{n}{section\PYZus{}dims}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{)}
                     \PY{n}{varylinewidth} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{int}\PY{p}{(}\PY{p}{(}\PY{n}{linewidth} \PY{o}{/} \PY{n}{scale\PYZus{}factor}\PY{p}{)} \PY{o}{*} \PY{p}{(}\PY{n}{colorvalue} \PY{o}{/} \PY{l+m+mi}{255}\PY{p}{)}\PY{p}{)}
                     \PY{n}{cv2}\PY{o}{.}\PY{n}{polylines}\PY{p}{(}\PY{n}{largeimagesigns}\PY{p}{,} \PY{p}{[}\PY{n}{points}\PY{p}{]}\PY{p}{,} \PY{k+kc}{True}\PY{p}{,} \PY{p}{(}\PY{n}{colorvalue}\PY{p}{,} \PY{n}{colorvalue}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{)}\PY{p}{,} \PY{n}{thickness} \PY{o}{=} \PY{n}{varylinewidth}\PY{p}{)}
                 \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{largeimagesigns}\PY{p}{)}
                 \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}        
...
Image with most probable sign locations (single sign labels):
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_49_79.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Processing the following image{\ldots}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_49_81.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Image with most probable sign locations:
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_49_83.png}
    \end{center}
    { \hspace*{\fill} \\}
...
Image with most probable sign locations (single sign labels):
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_49_85.png}
    \end{center}
    { \hspace*{\fill} \\}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{output_49_87.png}
    \end{center}
    { \hspace*{\fill} \\}
